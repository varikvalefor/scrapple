...
prane-zmadu b₁ b₂ = Σ M $ λ (wd , hd , kd) → All (Mapti wd hd) coords
  ...
  Mapti wd hd (i₁ , i₂) = ??.Is-just (lookup₂ sp₁ i₁ i₂) ⇒_ $ lookup₂ sp₁ i₁ i₂ ≡ lookup₂ sp₂ (mink i₁ wd) (mink i₂ hd)
    ...
    _⇒?_ A B {Relation.Nullary.yes cₐ} {Relation.Nullary.no N} = Relation.Nullary.no {!!}
    _⇒?_ A B {Relation.Nullary.no Nₐ} {Relation.Nullary.no N} = Relation.Nullary.yes $ inj₂ Nₐ
